...
function Like(checkbox) {
    if (checkbox.checked) {
        ...
        setTimeout(() => {
        checkbox.parentElement.children[0].src = "./img/like-blue.png";
        ...
        checkbox.parentElement.children[0].src = "./img/like-outline.png";
...
function newPost(text, type, src) {
    ...
    return Element("div", [
        ...
        Element("div", [
        { class: "header" },
        Element("img", [{ class: "profilePic", src: "./img/person.jpg" }]),
        Element("span", [{}, "MohamedElshaarawy"]),
        Element("span", [
            {},
        ...
        Element("label", [
            {},
            Element("img", [{ src: "./img/like-outline.png" }]),
            Element("span", [{}, "Like"]),
            Element("input", [
        ...
        Element("button", [
            {},
            Element("img", [{ src: "./img/comment-outline.png" }]),
            Element("span", [{}, "Comment"]),
        ]),
        Element("button", [
            {},
            Element("img", [{ src: "./img/share-outline.png" }]),
            Element("span", [{}, "Share"]),
        ]),
        ]),
    ]);
